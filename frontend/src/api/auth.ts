...
export interface AuthUser { id: number; username: string; email: string; name: string; role: 'student' | 'teacher' | 'admin'; class_name: string | null; must_change_password: boolean; mfa_enabled: boolean }
